...
public class UnitTest4
{
    ...
    public void AddTest()
    {
        ...
        MainMemory.load(new String[] {
                ...
                // Then on to 2R.
                "00000000000000001011100001000010", // MATH ADD R2 R2 R2.
                // Then on to 3R.
    ...
    public void MultiplyTest()
    {
        ...
        MainMemory.load(new String[] {
                ...
                // Then on to 3R.
                "00000000000010000101110001000011", // MATH MULTIPLY R1 R1 R2
                // Then on to 2R.
                "00000000000000001001110001000010", // MATH MULTIPLY R2 R2 R2
                // Then on to 3R.
                "00000000000100000101110001100011", // MATH MULTIPLY R2 R1 R3
                // Then on to 0R.
                "00000000000000000000000000000000" // HALT
        });
    ...
    public void SubtractTest()
    {
        ...
        MainMemory.load(new String[] {
                ...
                "00000000000000001011100001000010", // MATH ADD R2 R2 R2.
                // Then on to 3R.
                "00000000000100000111110001100011", // MATH SUBTRACT R2 R1 R3
                // Then on to 0R.
                "00000000000000000000000000000000" // HALT
        });
